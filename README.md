attempting to make a c1cx replacement, using the codebase of iw4x-sp and iw6-mod, so instead of using a .exe to inject a .dll into codmp, it would just use a single .exe to "wrap" codmp

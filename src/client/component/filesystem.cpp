...
namespace filesystem
{
	namespace
	{
		...
		{
			MessageBoxA(nullptr, "register_custom_path_stub", "cod-mod", MB_ICONINFORMATION);
			...
			if (!custom_path_registered)
			{
				...
				game::FS_AddGameDirectory(launcher_dir.data(), "main");
			}

			//MessageBoxA(nullptr, path, "cod-mod", MB_ICONINFORMATION);

			game::FS_AddGameDirectory(path, dir);
		}

		void fs_startup_stub(const char* gamename)
		{
			MessageBoxA(nullptr, "fs_startup_stub", "cod-mod", MB_ICONINFORMATION);
		...
		void startup()
		{
			MessageBoxA(nullptr, "filesystem startup", "cod-mod", MB_ICONINFORMATION);
	...
	public:
		...
		{
			// Set fs_basegame
			//utils::hook::inject(0x14041C053, "iw6");

			//utils::hook::jump(0x1404351B0, sys_default_install_path_stub);





			utils::hook::call(0x0042d21a, fs_startup_stub);
			utils::hook::call(0x0042d2d1, fs_startup_stub);
			utils::hook::call(0x0043bb0b, fs_startup_stub);

			utils::hook::call(0x0042c53c, register_custom_path_stub);
			utils::hook::call(0x0042c54e, register_custom_path_stub);
			utils::hook::call(0x0042cec6, register_custom_path_stub);
			utils::hook::call(0x0042ced8, register_custom_path_stub);
			utils::hook::call(0x0042cef9, register_custom_path_stub);
			utils::hook::call(0x0042cf0b, register_custom_path_stub);
		}
	};
}
